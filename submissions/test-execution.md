...
| TC-05 | View book list | The system displays the full book list for both Librarian and Member roles | The system successfully displays the complete book list after login | Pass | ![Alt text](hhttps://github.com/USTH-STQA-2026/Manual_testing_STQA_GR26/blob/main/screenshots/tx_tc05.PNG) | - |
...
|TC-14|Borrow books|Active members are allowed to borrow books and are informed of successful borrowing|The member is allowed to borrow and is informed of success| Pass |![Alt text](hhttps://github.com/USTH-STQA-2026/Manual_testing_STQA_GR26/blob/main/screenshots/tx_tc14.PNG)|-|
